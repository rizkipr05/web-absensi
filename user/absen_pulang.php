...
<div class="container-fluid p-0">
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="page-header-title">Absen Pulang</h2>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="home.php" class="text-decoration-none">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Pulang</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="alert alert-warning border-start border-4 border-warning shadow-sm" role="alert">
        <div class="d-flex align-items-center">
            ...
            <div>
                 <strong>Perhatian:</strong> Pastikan Anda sudah menyelesaikan pekerjaan hari ini sebelum melakukan absen pulang.
            </div>
        </div>
    </div>
        ...
        <div class="col-md-6">
            <div class="card card-custom h-100">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="absen_pulang_process.php" id="formAbsen">
                        ...
                        <button class="btn btn-dark w-100 py-3 fw-bold" type="submit" id="btnSubmit" disabled>
                            <i class="bi bi-box-arrow-left me-2"></i>Kirim Absen Pulang
                        </button>
                    </form>
...
function updateSubmitState() {
  ...
  if (!btnSubmit.disabled) {
      ...
      btnSubmit.classList.add('btn-warning'); // Warning for pulang to match logic/theme
...
btnCapture.addEventListener('click', () => {
  ...
  if (!w || !h) { alert("Kamera belum siap. Tunggu sebentar lalu coba lagi."); return; }
