...
<nav id="sidebar">
    <div class="sidebar-header">
        ...
        <div class="small mt-2 text-white-50">Panel User</div>
    </div>
    ...
    <ul class="list-unstyled components">
        ...
        <li class="<?= $current_page == 'absen_masuk.php' ? 'active' : '' ?>">
            <a href="absen_masuk.php">
                <i class="bi bi-box-arrow-in-right"></i> Absen Masuk
            </a>
        </li>
        <li class="<?= $current_page == 'absen_pulang.php' ? 'active' : '' ?>">
            <a href="absen_pulang.php">
        ...
        <div class="d-flex align-items-center">
            <div class="dropdown">
                <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle text-secondary" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <span class="d-none d-sm-inline fw-medium"><?= htmlspecialchars($_SESSION['user']['nama'] ?? 'User') ?></span>
                </a>
